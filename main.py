...
# reservoir area in km^2
# evap available in mm?
# q_max?
...
# algorithm = NSGAIII(problem,divisions_outer = 8, population_size = 810)
# algorithm = NSGAII(problem)
algorithm = EpsMOEA(problem, epsilons = [0.029],population_size = 190)
algorithm.run(10)
